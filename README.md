# PruebasCajaBlanca
 ° El cálculo de la complejidad ciclomática por las tres formas conocidas: 
 <br>
 - Aristas - Nodos + 2 

 - Nodos predicados + 1 

 - Regiones +1 (región externa)

 ° Los caminos posibles del grafo
<br>


 **PDF con toda la información de la complejidad Ciclomática:**



:arrow_right: :arrow_right: [Práctica de pruebas de caja blanca Grafos.pdf](https://github.com/user-attachments/files/25635709/Practica.de.pruebas.de.caja.blanca.Grafos.pdf)  :arrow_left: :arrow_left:
<br>
...
![ViajeGalactico](https://github.com/user-attachments/assets/2fa023c5-74e6-474c-8b96-113d3e78930b)
